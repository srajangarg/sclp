...
Register_Descriptor::Register_Descriptor(Spim_Register reg, string s,
                                         Register_Val_Type vt, Register_Use_Category uc)
{
    reg_id = reg;
    reg_name = s;
    value_type = vt;
...
Register_Use_Category Register_Descriptor::get_use_category()
{
    return reg_use;
}
...
string Register_Descriptor::get_name()
{
    return reg_name;
}
bool Register_Descriptor::is_symbol_list_empty()
{
    return lra_symbol_list.empty();
}

bool Register_Descriptor::is_register_occupied()
{
    return reg_occupied;
}
void Register_Descriptor::set_register_occupied()
{
    reg_occupied = true;
}
void Register_Descriptor::reset_register_occupied()
{
    reg_occupied = false;
}

bool Register_Descriptor::is_used_for_expr_result()
{
...
void Register_Descriptor::set_used_for_fn_return()
{
    used_for_fn_return = true;
}
void Register_Descriptor::reset_used_for_fn_return()
{
    used_for_fn_return = false;
}
bool Register_Descriptor::is_used_for_fn_return()
{
    return used_for_fn_return;
}
...
{
    if ((reg_use == dt) && (lra_symbol_list.empty())
        && (is_used_for_expr_result() == false) && (is_register_occupied() == false))
        return true;
    else
        return false;
}
...
{
    spim_instruction_table[store]
        = new Instruction_Descriptor(store, "store", "sw", "", i_r_op_o1, a_op_o1_r);
    spim_instruction_table[load]
        = new Instruction_Descriptor(load, "load", "lw", "", i_r_op_o1, a_op_r_o1);
    spim_instruction_table[la]
        = new Instruction_Descriptor(la, "loadAdd", "la", "", i_r_op_o1, a_op_r_o1);
    spim_instruction_table[imm_load]
        = new Instruction_Descriptor(imm_load, "iLoad", "li", "", i_r_op_o1, a_op_r_o1);
    spim_instruction_table[and_t]
        = new Instruction_Descriptor(and_t, "and", "and", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[or_t]
        = new Instruction_Descriptor(or_t, "or", "or", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[not_t] = new Instruction_Descriptor(
        not_t, "not", "sltu", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[mov]
        = new Instruction_Descriptor(mov, "move", "move", "", i_r_op_o1, a_op_r_o1);
    spim_instruction_table[add]
        = new Instruction_Descriptor(add, "add", "add", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[sub]
        = new Instruction_Descriptor(sub, "sub", "sub", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[mult]
        = new Instruction_Descriptor(mult, "mul", "mul", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[divd]
        = new Instruction_Descriptor(divd, "div", "div", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[imm_add] = new Instruction_Descriptor(
        imm_add, "addi", "addi", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[uminus]
        = new Instruction_Descriptor(uminus, "uminus", "neg", "", i_r_op_o1, a_op_r_o1);
    spim_instruction_table[store_d]
        = new Instruction_Descriptor(store_d, "store.d", "s.d", "", i_r_op_o1, a_op_o1_r);
    spim_instruction_table[load_d]
        = new Instruction_Descriptor(load_d, "load.d", "l.d", "", i_r_op_o1, a_op_r_o1);
    spim_instruction_table[imm_load_d] = new Instruction_Descriptor(
        imm_load_d, "iLoad.d", "li.d", "", i_r_op_o1, a_op_r_o1);
    spim_instruction_table[mov_d]
        = new Instruction_Descriptor(move_d, "move.d", "mov.d", "", i_r_op_o1, a_op_r_o1);
    spim_instruction_table[add_d] = new Instruction_Descriptor(
        add_d, "add.d", "add.d", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[sub_d] = new Instruction_Descriptor(
        sub_d, "sub.d", "sub.d", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[mult_d] = new Instruction_Descriptor(
        mult_d, "mul.d", "mul.d", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[div_d] = new Instruction_Descriptor(
        div_d, "div.d", "div.d", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[uminus_d] = new Instruction_Descriptor(
        uminus_d, "uminus.d", "neg.d", "", i_r_op_o1, a_op_r_o1);
    spim_instruction_table[slt]
        = new Instruction_Descriptor(slt, "slt", "slt", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[sle]
        = new Instruction_Descriptor(sle, "sle", "sle", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[sgt]
        = new Instruction_Descriptor(sgt, "sgt", "sgt", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[sge]
        = new Instruction_Descriptor(sge, "sge", "sge", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[seq]
        = new Instruction_Descriptor(seq, "seq", "seq", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[sne]
        = new Instruction_Descriptor(sne, "sne", "sne", "", i_r_o1_op_o2, a_op_r_o1_o2);
    spim_instruction_table[beq]
        = new Instruction_Descriptor(beq, "beq", "beq", "", i_op_o1_o2_st, a_op_o1_o2_st);
    spim_instruction_table[bne]
        = new Instruction_Descriptor(bne, "bne", "bne", "", i_op_o1_o2_st, a_op_o1_o2_st);
    spim_instruction_table[bgtz] = new Instruction_Descriptor(
        bgtz, "bgtz", "bgtz", "", i_op_o1_o2_st, a_op_o1_o2_st);
    spim_instruction_table[bgez] = new Instruction_Descriptor(
        bgez, "bgez", "bgez", "", i_op_o1_o2_st, a_op_o1_o2_st);
    spim_instruction_table[bltz] = new Instruction_Descriptor(
        bltz, "bltz", "bltz", "", i_op_o1_o2_st, a_op_o1_o2_st);
    spim_instruction_table[blez] = new Instruction_Descriptor(
        blez, "blez", "blez", "", i_op_o1_o2_st, a_op_o1_o2_st);
    spim_instruction_table[j]
        = new Instruction_Descriptor(j, "jump", "j", "", i_op_st, a_op_st);
    spim_instruction_table[jal]
        = new Instruction_Descriptor(jal, "jal", "jal", "", i_op_st, a_op_st);
    spim_instruction_table[syscall]
        = new Instruction_Descriptor(syscall, "syscall", "syscall", "", i_op_st, a_op_st);
    spim_instruction_table[label]
        = new Instruction_Descriptor(label, "", "", "", i_op_st, a_op_st);
    spim_instruction_table[ret_inst]
        = new Instruction_Descriptor(ret_inst, "return", "", "", i_op, a_op);
    spim_instruction_table[seq_d] = new Instruction_Descriptor(
        seq_d, "seq.d", "c.eq.d", "", i_o1_op_o2, a_op_o1_o2);
    spim_instruction_table[slt_d] = new Instruction_Descriptor(
        slt_d, "slt.d", "c.lt.d", "", i_o1_op_o2, a_op_o1_o2);
    spim_instruction_table[sle_d] = new Instruction_Descriptor(
        sle_d, "sle.d", "c.le.d", "", i_o1_op_o2, a_op_o1_o2);
    spim_instruction_table[bc1t]
        = new Instruction_Descriptor(bc1t, "bc1t", "bc1t", "", i_op_st, a_op_st);
    spim_instruction_table[bc1f]
        = new Instruction_Descriptor(bc1f, "bc1f", "bc1f", "", i_op_st, a_op_st);
}
    ...
    for (i = spim_register_table.begin(); i != spim_register_table.end(); i++) {
        ...
        if (reg_desc->is_used_for_fn_return() == false) {
            if (reg_desc->get_use_category() == gp_data) {
                CHECK_INVARIANT((reg_desc->is_free<gp_data>()),
                                "GP data registers should be free at the start of a "
                                "basic block or after a function call");
            }

            else if (reg_desc->get_use_category() == float_reg) {
                CHECK_INVARIANT((reg_desc->is_free<float_reg>()),
                                "Float data registers should be free at the start of a "
                                "basic block or after a function call");
            }
        }
    }
...
void Machine_Description::validate_init_local_register_mapping()
{
    ...
    for (i = spim_register_table.begin(); i != spim_register_table.end(); i++) {
        ...
        if (reg_desc->get_use_category() == gp_data) {
            CHECK_INVARIANT((reg_desc->is_free<gp_data>()),
                            "GP data registers should be free at the start of a basic "
                            "block or after a function call");
        }

        else if (reg_desc->get_use_category() == float_reg) {
            CHECK_INVARIANT((reg_desc->is_free<float_reg>()),
                            "Float data registers should be free at the start of a basic "
                            "block or after a function call");
        }
    }
}
...
Register_Descriptor *Machine_Description::get_new_register()
{
    ...
    if (count > 0)
        ...
        CHECK_INVARIANT(CONTROL_SHOULD_NOT_REACH, "Error in get_new_reg or register "
...
void Machine_Description::clear_reg_not_used_for_expr_result()
{
    ...
    for (i = spim_register_table.begin(); i != spim_register_table.end(); i++) {
        ...
        if (!rdp->is_used_for_expr_result()) {
            rdp->reset_register_occupied(); /* reset reg occupied i.e register is not
                                               anymore occupied */
