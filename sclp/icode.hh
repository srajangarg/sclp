...
typedef enum {       /* a: assembly format; r: result; o1: opd1; o2: opd2; op: operator */
...
typedef enum { /* i: intermediate format; r: result; o1: opd1; o2: opd2; op: operator */
...
public:
    Instruction_Descriptor(Tgt_Op op, string name, string mnn, string ics,
                           Icode_Format icf, Assembly_Format af);
