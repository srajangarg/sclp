...
bool Assignment_Ast::check_ast()
{
    ...
    CHECK_INPUT(CONTROL_SHOULD_NOT_REACH, "Assignment statement data type not compatible",
                lineno);
    return false;
}
...
Data_Type Name_Ast::get_data_type()
{
    ...
    CHECK_INVARIANT((variable_symbol_entry != NULL),
                    "Symbol_Table_Entry should be non null");
...
bool Relational_Expr_Ast::check_ast()
{
    ...
    CHECK_INPUT(CONTROL_SHOULD_NOT_REACH, "Relational statement data type not compatible",
                lineno);
}
